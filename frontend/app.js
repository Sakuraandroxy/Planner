let state={version:0,status:"starting",task:"",step:0,max_steps:20,pose:[0,0,0],yaw:0,collided:false,reasoning:"",reasoning_summary:"",scene_analysis:"",candidates:[],selected:[],error:""};
